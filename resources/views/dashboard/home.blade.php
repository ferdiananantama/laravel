        ...
        <div id="default-carousel" class="relative max-w-screen-xl mx-auto" data-carousel="slide">
            ...
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src={{ asset('assets/img/coba.jpg') }} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src={{ asset('assets/img/coba.jpg') }} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        ...
        <div class="mt-20 md:mb-36 mb-28" id="card-list">
            <div>
                ...
                <div id="card" class="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-4">
                    <a href="/detail-card-login" class="border border-gray-100 shadow-md rounded-md overflow-hidden ease-in duration-300 hover:scale-105 cursor-pointer">
                        <img src="{{asset('assets/img/holi.jpg')}}" width="320" alt="">
                        <div id="content-card" class="p-3">
                            <header class="font-semibold md:text-lg text-base mt-2">
                                Nama Event
                            </header>
                            <p class="md:text-sm text-xs text-[#A3A3A3] font-extralight mb-4 md:mb-6">Tanggal Event</p>
                            <div class="flex justify-between mb-3">
                                <div class="font-medium md:text-sm text-xs">Start From</div>
                                <div class="md:text-sm text-xs font-semibold text-[#003E29]">Rp 200,000</div>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="md:text-sm text-xs text-[#B0B0B0] font-extralight">Lokasi</p>
                            </div>
                        </div>
                    </a>
                    <a href="/detail-card-login" class="border border-gray-100 shadow-md rounded-md overflow-hidden ease-in duration-300 hover:scale-105 cursor-pointer">
